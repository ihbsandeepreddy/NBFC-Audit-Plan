"""
DA-045: Borrower Concentration by Segment
Top 20 borrowers analysis; flag concentration risk
LMS Risk Theme: 10
CAP Seq: R.15
"""
...
METADATA = {
    "da_ref": "DA-045",
    "name": "Borrower Concentration by Segment",
    "description": "Top 20 borrowers analysis; flag concentration risk",
    "cap_seq": "R.15",
    "risk_theme": 10,
...
def run(
    ...
    **kwargs
    ...
    """
    Borrower Concentration by Segment
